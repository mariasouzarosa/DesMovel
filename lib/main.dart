...
List<Item> items = [
  Item(
    "https://static.vecteezy.com/ti/vetor-gratis/p1/582468-icone-de-casa-ilustracaoial-gr%C3%A1tis-vetor.jpg",
    "COMPRAR",
    """Imoveis disponíveis para compra.""",
  ),
  Item(
    "https://static.vecteezy.com/ti/vetor-gratis/p1/581797-icone-de-casa-ilustracaoial-gr%C3%A1tis-vetor.jpg",
    "ALUGAR",
    "Imoveis disponiveis para alugar",
  ),
  Item(
    "https://media.istockphoto.com/vectors/customer-service-woman-with-headphones-and-microphone-with-laptop-vector-id1158211277",
    "ATEDIMENTO",
    "Contato/Atendimento",
  ),
  Item(
    "https://static6.depositphotos.com/1000816/620/i/600/depositphotos_6203871-stock-photo-handshake-hand-holding-on-black.jpg",
    "NEGOCIAÇÕES",
    "Negociações",
  ),
];
